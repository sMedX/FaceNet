...
class Validation:
    def __init__(self, thresholds, embeddings, labels,
        ...
        print('Sensitivity (TPR, 1-a type 1 error): {:2.5f}+-{:2.5f}'.format(self.tp_rates_mean, self.tp_rates_std))
        print('Specificity (TNR, 1-b type 2 error): {:2.5f}+-{:2.5f}'.format(self.tn_rates_mean, self.tn_rates_std))
        print()
